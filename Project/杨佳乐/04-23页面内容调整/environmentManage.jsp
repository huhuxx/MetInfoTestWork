...
<div id=top_3>
	...
	<table id="table" border="3">
		...
		<c:forEach var="row" items="${page.list}">
		<tr>
		   ...
		   <td class="td" align="center"> 	
		   	   	<input id=top_up type="button" onclick="editwindow(${row.environmentId})" value="编辑"/>			
		   	</td>
		   	<td class="td" align="center">
		   		 <input id=top_del type="button" onclick="deletewindow(${row.environmentId})" value="删除"/>   	 	
		   	</td>			
		</tr>
		</c:forEach>
	</table>
	<div class="pageNum">
				...
				<a class="page" href="environmentList?page=1">首页</a>
				<a class="page" href="environmentList?page=${page.prePageNum }">上一页</a>
			
				第${page.currentPageNum }页
				
				<a class="page" href="environmentList?page=${page.nextPageNum }">下一页</a>
				<a class="page" href="environmentList?page=${page.totalPageNum }">末页</a>
		</div>
	</div>
	</div>
