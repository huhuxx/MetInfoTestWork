...
public class BodybuildingPages {
	...
	public AndroidElement click_back_one() {
		return driver.findElementById("com.example.fitnessdemo:id/iv_clb_cusp1");
	}
	
	public void inter_fourteen_one() throws InterruptedException {
		action.click(click_back());
		Thread.sleep(3000);
		action.click(click_back_one());
		Thread.sleep(3000);
	}
	...
	public void inter_fifteen_one() throws InterruptedException {
		action.click(click_kecheng());
		Thread.sleep(3000);
	}
	
	// 16,进入主页，点击健身百科，点击饮食，点击减脂餐，点击免费课程，点击第一个课程，点击视频列表，（查看第一个视频）还没写
