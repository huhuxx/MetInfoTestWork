...
<div id="right">
	<div id="right_index">
		<div id="right_index_img"><img alt="" src="images/b_sy_sy.png"></div>
		<div id="right_index_text">首页</div>
	</div>
	<div id="right_middle">
		<div id="xm">
			<div id="xm_img"><img alt="" src="images/b_sy_xm.png"></div>
			<div id="xm_text">
				<p>3</p>
				<p>项目</p>
			</div>
		...
		<div id="jk">
			<div id="jk_img"><img alt="" src="images/b_sy_jk.png"></div>
			<div id="jk_text">
				<p>5</p>
				<p>接口</p>
			</div>
		...
		<div id="rw">
			<div id="rw_img"><img alt="" src="images/b_sy_rw.png"></div>
			<div id="rw_text">
				<p>40</p>
				<p>任务</p>
			</div>
		...
		<div id="person">
			<div id="person_img"><img alt="" src="images/b_sy_csry.png"></div>
			<div id="person_text">
				<p>5</p>
				<p>测试人员</p>
			</div>
	...
	<div id="right_report">
		<img height='500px' src="images/b_sy_test.png"/>
	</div>
</div>
</body>
