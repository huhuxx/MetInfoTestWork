...
//启动谷歌浏览器
	public WebDriver startChrome(String url) throws Exception {
		try {
			System.setProperty("webdriver.chrome.driver", "D:\\demo\\driver\\chromedriver.exe");
...
// System.setProperty("webdriver.firefox.marionette","D:\\demo\\driver\\geckodriver.exe");
...
//启动IE浏览器
	public WebDriver startIE(String url) throws Exception {
		try {
			System.setProperty("webdriver.ie.driver", "D:\\demo\\driver\\IEDriverServer.exe");
