...
public class JoinusjobTest extends BaseTest{
	...
	public void test11() throws InterruptedException {
		...
		webtest.click("xpath=//div[@id='job-list-43--_wrapper']/table/tbody/tr[2]/td[5]/button[@class='btn btn-sm btn-primary mr-1']");
		Thread.sleep(5000);
		List<WebElement> list = webtest.backlist("xpath=//*[@class='btn btn-default mr-1']");
	...
	public void test12() throws InterruptedException {
		//简历信息管理-导出第二个简历并返回本页
		webtest.click("xpath=//*[text()='简历信息管理']");
		webtest.click("xpath=//div[@id='job-list-43--_wrapper']/table/tbody/tr[2]/td[5]/a");
	...
	public void test13() throws InterruptedException {
		...
		webtest.click("xpath=//*[text()='简历信息管理']");
		Thread.sleep(5000);
		webtest.click("xpath=//*[@id='job-list-43--']/tbody/tr[3]/td[8]/button[2]");
		webtest.click("xpath=//*[@class='ok btn btn-primary']");
	}
	@Test
