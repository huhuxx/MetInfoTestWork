...
public class Joinus_jianliTest extends BaseTest {
	...
	public void test9() throws InterruptedException {
		...
		webtest.click("xpath=//*[@id=\"parameter-list-job-43-0-0\"]/tfoot/tr/th[2]/button[text()='添加']");
		Thread.sleep(5000);
		webtest.type("xpath=//*[@id='parameter-list-job-43-0-0']/tbody/tr[13]/td[2]/div/input","这是新添加的带下拉项");
		
		webtest.click("xpath=//*[@name='type-195']");
		webtest.click("xpath=//*[@id='parameter-list-job-43-0-0']/tbody/tr[13]/td[4]/select/option[text()='下拉']");
		List<WebElement> list = webtest.backlist("xpath=//*[text()='设置选项']");
		System.out.println("设置选项的数量："+list.size());
		webtest.click(list.get(13));
		webtest.click("xpath=//*[@id=\"parameter-options-list\"]/tfoot/tr/th[2]/button[text()='添加']");
		webtest.type("xpath=//*[@id=\"parameter-options-list\"]/tbody/tr/td[2]/div/input","1");
		webtest.type("xpath=//*[@id=\"parameter-options-list\"]/tbody/tr[1]/td[2]/div/input","2");
		webtest.type("xpath=//*[@id=\"parameter-options-list\"]/tbody/tr[2]/td[2]/div/input","3");
		webtest.click("xpath=//*[@id=\"parameter-list-job-43-0-0\"]/tfoot/tr/th[2]/button[text()='保存']");
	...
	public void test10() throws InterruptedException {
		...
		webtest.click("xpath=//*[@id=\"parameter-list-job-43-0-0\"]/tfoot/tr/th[2]/button[text()='添加']");
		Thread.sleep(5000);
		webtest.type("xpath=//*[@id=\"parameter-list-job-43-0-0\"]/tbody/tr[15]/td[2]/div/input","这是新添加的带多选项");
