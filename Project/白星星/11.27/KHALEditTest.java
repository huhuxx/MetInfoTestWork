...
public class KHALEditTest extends BaseTest {
	@Test
	public void testEditDelete1() throws InterruptedException {
		webtest.click("xpath=//a[@class='btn btn-outline btn-inverse met-img-showbtn']");
		Thread.sleep(5000);
		...
		List<WebElement> list2 = webtest.backlist("xpath=//*[@class='glyphicon glyphicon-trash text-grey']");
		webtest.click(list2.get(1));
		webtest.enterFrame("ueditor_0");
		webtest.typeAndClear("xpath=//*[@class='view']", "这是删除图片后的介绍内容");
	...
	@Test
	public void testEdit4() throws InterruptedException {
		//将回收站所有的内容删除
		webtest.click("xpath=//a[text()='内容']");
		webtest.click("xpath=//*[@class='fa-recycle']");
	...
	public void testEditAdd5() throws InterruptedException {
		...
		//添加本地图片
		webtest.type("xpath=//*[@name='imgurl']","D:\\ABCD\\1.jpg");
...
//		添加新的内容带有超链接的内容
	...
	@Test
	public void testEditAdd11() throws InterruptedException {
		//详细内容中多图上传
		webtest.click("xpath=//a[text()='内容']");
		List<WebElement> list = webtest.backlist("xpath=//*[@class='py-2 d-block']");
		webtest.click(list.get(4));
		...
		//*[@class='%%-iframe edui-insertimage-iframe']
		webtest.enterFrame("xpath=/html/body/div[6]/div[2]/div/div/div[3]/iframe");
		webtest.type("name=file","D://ABCD//2.jpg");
//		webtest.click("xpath=//*[@class='webuploader-pick']");
		webtest.type("name=file","D://ABCD//3.jpg");
		webtest.type("name=file","D://ABCD//4.jpg");
		webtest.click("xpath=//*[@class='uploadBtn state-confirm state-finish disabled']");
		webtest.leaveFrame();
		webtest.click("id=edui361_body");
