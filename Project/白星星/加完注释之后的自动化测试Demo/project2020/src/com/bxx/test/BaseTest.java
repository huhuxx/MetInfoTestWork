...
/**
 * 测试基类
 * 实现：浏览器打开、网页打开登录、freemarker完成报告、压缩、发邮件、监听器、关闭网页的作用
 * 
 * @author 白星星
 *
 */
public class BaseTest {
	...
	@BeforeMethod(description = "打开页面并登录")
	...
	@AfterSuite(description = "freemarker制作测试结果页面、压缩、发邮件")
