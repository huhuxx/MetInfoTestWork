...
public class JoinuszhaopinTest extends BaseTest {
	...
	@BeforeMethod(description = "进入加入我们后台的招聘系统配置页面")
	...
	public void test1() throws InterruptedException {
		...
		webtest.typeAndClear("xpath=//*[@name='met_cv_to']","1336124020@qq.com|13113893039@126.com");
		webtest.typeAndClear("xpath=//*[@name='met_cv_job_tel']", "13113893039");
		
		webtest.click("xpath=//*[@id='job-set-form']/div/dl[15]/dd/button[text()='保存']");
	}
	@Test(description = "填写邮件回复设置，点击【保存】")
	...
	@Test(description = "填写短信回复设置，点击【保存】")
	public void test3() throws InterruptedException {
		webtest.click("xpath=//*[@name='met_cv_sms_back']");
		webtest.typeAndClear("xpath=//*[@name='met_cv_sms_content']", "回复短信内容需要在短信功能提供平台提交内容模板审核，审核通过后才能发送成功。");
