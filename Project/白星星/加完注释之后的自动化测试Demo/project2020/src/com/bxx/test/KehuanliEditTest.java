...
/**
 * 客户案例的后台管理页面
 * 客户案例展示内容的增删改查、展示状态的修改、增加内容的来源、回收站的恢复
 * 实现数据驱动
 * 
 * @author 白星星
 *
...
public class KehuanliEditTest extends BaseTest {
	...
	@Test(priority = 1,description = "将第二个放入回收站")
	...
	@Test(priority = 2,description = "将第二个从回收站恢复")
	...
	@Test(description = "添加新的内容带有本地视频的内容")
	...
	@Test(description = "添加新的内容带有网络视频的内容")
	...
	@Test(description = "添加新的内容带有超链接的内容")
