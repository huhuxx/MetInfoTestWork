...
public class JoinuspageTest extends BaseTest {
	...
	public void text1() throws InterruptedException {
		...
		webtest.click("xpath=//a[@data-jobid='13']");
		Thread.sleep(5000);
		webtest.type("xpath=//*[@id='met-job-cv0']/div/div/div[2]/form/div[1]/input", "王琦");
	...
	public void test3() throws InterruptedException {
		...
		webtest.type("xpath=//*[@id='met-job-cv0']/div/div/div[2]/form/div[3]/input", "135682634");
		webtest.type("xpath=//*[@id='met-job-cv0']/div/div/div[2]/form/div[4]/input", "13113893039@163.com");
		webtest.type("xpath=//*[@id='met-job-cv0']/div/div/div[2]/form/div[14]/div/input", "1");
		webtest.click("xpath=//*[@id='met-job-cv0']/div/div/div[2]/form/div[15]/button[1]");
	}
