...
<body>
	<div id = "form">
		<div id = "title"><p id="title_text">删除项目</p></div>
			<form action="DeleteEnvironmentServlet" method="post" id="form1">
				<div id="li_title">
					<ul id="ul_title">
						<li id="li_name">请确认需要删除的项目id</li>
					</ul>
				</div>
				
				<div id="li_text">
					<ul id="ul_text">
						<li><input type="text" name="IprojectId" value="请输入" id="inputid"/></li>
						<li><%String btnname = request.getParameter("IprojectId"); %></li>
					</ul>
				</div>
			  	<div id="submit">
