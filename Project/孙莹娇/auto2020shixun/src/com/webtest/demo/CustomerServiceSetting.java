...
public class CustomerServiceSetting extends BaseTest {
	...
	/**
	 * 打开客服服务的设置页面 CustomerService以CS代称
	 * 
	...
	/**
	 * 测试方法37 ID198 客服设置-客服列表-号码/链接/图片修改
	 * 
	 * @throws InterruptedException
	 */
	@Test(priority = 2)
	...
	public void addCS() throws InterruptedException {
		...
		webtest.click(
				"xpath=//input[@data-fv-field='value-new-0']/../../following-sibling::td[1]//button[text()='选择图标']");
	...
	public void CSstyleSetting() throws InterruptedException {
		...
		webtest.enterFrame1("xpath=//iframe[@src='" + ReadProperties.getPropertyValue("iframe_src") + "']");
		Thread.sleep(2000);
		String afterEdit_CScolor = webtest.getValue("xpath=//div[@class='onlinebox_two_list']/div[1]/a[last()]",
				"style");
