...
public class NowPageSetting extends BaseTest {
	...
	public void chooseLocalImg(String fileName, String imgTitle) throws InterruptedException {
		...
		webtest.click(
				"xpath=//div[@class='modal-dialog modal-dialog- modal-xl my-0 mx-auto h-100']/div//button[@class='btn btn-primary']");
	}

	/**
	 * 测试方法1 ID20 当前页设置网站基本信息设置
	 * 
	 * @param logoInfo logo数据驱动的参数
	 * @throws InterruptedException
	 */
	...
	/**
	 * 测试方法2 ID22 “添加外部图片”替换网站LOGO和手机站LOGO
	 * 
	 * @throws InterruptedException
	 */
	@Test(priority = 2)
	public void otherImg() throws InterruptedException {
		...
		// 添加外部图片界面-保存、关闭
		webtest.click(
				"xpath=//div[@class='modal-dialog modal-dialog-centered modal- ']/div//button[@class='btn btn-primary']");
	...
	/**
	 * 测试方法3 ID23 “选择文件夹上传”图片替换网站LOGO、手机站LOGO和地址栏图标
	 * 
	 * @param localImg 本地logo图片的数据驱动参数
	 * @throws InterruptedException
	 */
	@Test(priority = 3, dataProvider = "localImg", dataProviderClass = NSDataProvider.class)
	public void localImg(String localImg) throws InterruptedException {
		webtest.click("xpath=//a[@title='当前页面系统参数设置']");
		webtest.down(6);
		List<WebElement> inputElements = webtest.getElementsList("xpath=//input[@type='file']");
		// 替换网站LOGO
		webtest.type(inputElements.get(0), localImg);
		Thread.sleep(2000);
		webtest.click("xpath=//button[@class='btn btn-primary']");
		// 替换手机站LOGO
		webtest.type(inputElements.get(1), localImg);
		Thread.sleep(2000);
		// 替换地址栏图标
	...
	/**
	 * 测试方法22 ID174 当前页设置-基本信息-底部信息设置-基本信息修改
	 * 
	 * @throws InterruptedException
	 */
	...
	/**
	 * 测试方法23ID175 当前页设置-基本信息-底部信息设置-其他信息修改
	 * 
	 * @throws InterruptedException
	 */
	@Test(priority = 5)
	...
	/**
	 * 测试方法24 ID176 当前页设置-基本信息-底部信息设置-系统版权文字风格修改 ：设置系统版权文字风格为第二个选项
	 * 
	 * @throws InterruptedException
	 */
