...
public class EditorialColumn extends BaseTest {
	...
	public void set_newWindow_no() throws InterruptedException {
		...
		save();
		Thread.sleep(1000);
		assertEquals(get_set_window_no(), get_set_window_no());
	}
	public void set_sortStyle_updateTime() throws InterruptedException {
		...
		save();
		Thread.sleep(1000);
		assertEquals(get_set_sortStyle_updateTime(), get_set_sortStyle_updateTime());
	}
	public void set_sortStyle_releaseTime() throws InterruptedException {
		...
		save();
		Thread.sleep(1000);
		assertEquals(get_set_sortStyle_releaseTime(), get_set_sortStyle_releaseTime());
	}
	public void set_sortStyle_clickNumber() throws InterruptedException {
		...
		save();
		Thread.sleep(1000);
		assertEquals(get_set_sortStyle_clickNumber(), get_set_sortStyle_clickNumber());
	}
	public void set_sortStyle_daoxu() throws InterruptedException {
		//设置页面设置列表页排序方式为更新时间
		intoSet();
		get_set_sortStyle_idDaoxu().click();
		Thread.sleep(1000);
		save();
		Thread.sleep(1000);
		assertEquals(get_set_sortStyle_idDaoxu(), get_set_sortStyle_idDaoxu());
	}
	public void set_sortStyle_zhengxu() throws InterruptedException {
		//设置页面设置列表页排序方式为更新时间
		intoSet();
		get_set_sortStyle_idZheng().click();
		Thread.sleep(1000);
		save();
		Thread.sleep(1000);
		assertEquals(get_set_sortStyle_idZheng(), get_set_sortStyle_idZheng());
	}
}
