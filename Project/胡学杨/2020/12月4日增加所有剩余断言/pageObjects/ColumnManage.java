...
public class ColumnManage {
	...
	public WebElement get_assert() {
		return driver.findElement(By.xpath("//input[@value='dell笔记本电脑']"));
	}
...
//		action.moveToElement(get_row()).perform();
	...
	public void setDisplay_no() throws InterruptedException {
		...
		save();
		Thread.sleep(1000);
		assertEquals(get_checked().getText(), "不显示");
	}
	public void setDisplay_head() throws InterruptedException {
		...
		save();
		Thread.sleep(1000);
		assertEquals(get_checked().getText(), "头部导航栏显示");
	}
	public void setDisplay_tail() throws InterruptedException {
		...
		save();
		Thread.sleep(1000);
		assertEquals(get_checked().getText(), "尾部导航栏显示");
	}
	public void setDisplay_all() throws InterruptedException {
		...
		save();
		Thread.sleep(1000);
		assertEquals(get_checked().getText(), "都显示");
	}
	public void addColumn() throws InterruptedException {
		...
		get_add_save().click();
		Thread.sleep(1000);
		assertEquals(get_assert(),get_assert());
	}
}