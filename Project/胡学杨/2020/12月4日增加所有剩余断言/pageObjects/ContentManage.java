...
//		WebElement selectSingle = driver.findElement(By.xpath("//select[@data-checked='4-5-0']"));
	...
	public WebElement column_selected() {
		//被选元素
		return driver.findElement(By.xpath("//option[@selected='selected']"));
	}
	public void column_assert(String s) throws InterruptedException {
		//断言
		get_edit().click();
		Thread.sleep(1000);
		assertEquals(s, column_selected().getText());
	}
	...
	public void editContent_text_size(String size) throws InterruptedException {
		//编辑内容，设置字体大小
		intoProductShow();
		get_edit().click();
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		get_edit_textsize().sendKeys(size);
		Thread.sleep(1000);
		assertEquals(get_edit_textsize().getAttribute("value"), size);
	    save();
	    Thread.sleep(1000);
	}
	public void editContent_text_color(String color) throws InterruptedException {
		//编辑内容，设置字体颜色
		intoProductShow();
		get_edit().click();
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		get_edit_textcolor().sendKeys(color);
		Thread.sleep(1000);
		assertEquals(get_edit_textcolor().getAttribute("value"), color);
	    save();
	    Thread.sleep(1000);
	}
	public void editContent_model(String x) throws InterruptedException {
		//修改型号
		intoProductShow();
		get_edit().click();
		Thread.sleep(1000);
		...
		while(true) {
		    ...
		    try {
		        ...
		        Thread.sleep(1000);
		        get_edit_model().sendKeys(x);
		        Thread.sleep(1000);
		        assertEquals(get_edit_model().getAttribute("value"), x);
		        break;
		    } catch (Exception e) {
		    }
		}
	...
	public void editContent_JingDong(String jdurl) throws InterruptedException {
		//修改京东网址
		intoProductShow();
		get_edit().click();
		Thread.sleep(1000);
		...
		while(true) {
		    ...
		    try {
		        ...
		        Thread.sleep(1000);
		        get_edit_JingDong().sendKeys(jdurl);
		        Thread.sleep(1000);
		        assertEquals(get_edit_JingDong().getAttribute("value"), jdurl);
		        break;
		    } catch (Exception e) {
		    }
		}
	...
	public void editContent_Taobao(String tdurl) throws InterruptedException {
		//修改型号
		intoProductShow();
		get_edit().click();
		Thread.sleep(1000);
		...
		while(true) {
		    ...
		    try {
		        ...
		        Thread.sleep(1000);
		        get_edit_TaoBao().sendKeys(tdurl);
		        Thread.sleep(1000);
		        assertEquals(get_edit_TaoBao().getAttribute("value"), tdurl);
		        break;
		    } catch (Exception e) {
		    }
		}
