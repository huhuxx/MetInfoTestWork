...
//		return driver.findElement(By.xpath("//input[@value='#ffffff']"));
	...
	public void set_background_color() throws InterruptedException {
		...
		Thread.sleep(1000);
		intoProductShow();
		assertEquals(get_setbackrground_color().getAttribute("value"), "#1baadb");
	}
	...
	public void set_text_color() throws InterruptedException {
		...
		Thread.sleep(1000);
		intoProductShow();
		assertEquals(get_settext_color().getAttribute("value"), "#ffffff");
	}
	...
	public void set_text_distance() throws InterruptedException {
		...
		Thread.sleep(1000);
		intoProductShow();
		assertEquals(get_settext_distance().getAttribute("value"), "5");
	}
}
