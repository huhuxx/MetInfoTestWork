...
//		return driver.findElement(By.xpath("//input[@value='请输入你感兴趣的关键词；']"));
	...
	public String get_placeholder() {
		...
		return driver.findElement(By.xpath("//input[@class='form-control input-lg']")).getAttribute("placeholder");
	}
	...
	public void set_content_text() throws InterruptedException {
		...
		Thread.sleep(1000);
		save();
		assertEquals(get_placeholder(), "请输入");
		Thread.sleep(1000);
	}
	public void set_content_number() throws InterruptedException {
		...
		Thread.sleep(1000);
		save();
		assertEquals(get_placeholder(), "123");
		Thread.sleep(1000);
	}
	...
	public void set_content_all() throws InterruptedException {
		...
		Thread.sleep(1000);
		save();
		assertEquals(get_placeholder(), "请输入1个关键词；");
		Thread.sleep(1000);
	}
	public void set_content_data(String text) throws InterruptedException {
		...
		Thread.sleep(1000);
		save();
		assertEquals(get_placeholder(),text);
		Thread.sleep(1000);
	}
}
